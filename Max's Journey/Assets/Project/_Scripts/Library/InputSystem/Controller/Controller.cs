...
//     version 1.10.0
//     from Assets/Project/_Scripts/Library/InputSystem/Controller/Controller.inputactions
//
...
public partial class @Controller: IInputActionCollection2, IDisposable
{
    ...
    ~@Controller()
    {
        UnityEngine.Debug.Assert(!m_CharacterControls.enabled, "This will cause a leak and performance issues, Controller.CharacterControls.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_CameraController.enabled, "This will cause a leak and performance issues, Controller.CameraController.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_InteractionController.enabled, "This will cause a leak and performance issues, Controller.InteractionController.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_CombatController.enabled, "This will cause a leak and performance issues, Controller.CombatController.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_AimController.enabled, "This will cause a leak and performance issues, Controller.AimController.Disable() has not been called.");
    }
